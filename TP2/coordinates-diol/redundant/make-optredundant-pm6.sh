...
if ! [[ -f head-optredundant-pm6 &&  -f  bottom ]]; then
...
echo "%chk=$NAME-opt" > $NAME-redundant-pm6-opt.com
cat head-optredundant-pm6 $NAME.cut $NAME-bottom >> $NAME-redundant-pm6-opt.com
rm $NAME.cut
