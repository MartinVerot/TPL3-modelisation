...
if ! [[ -f head-optredundant-pm3 &&  -f  bottom ]]; then
...
echo "%chk=$NAME-opt" > $NAME-redundant-pm3-opt.com
cat head-optredundant-pm3 $NAME.cut $NAME-bottom >> $NAME-redundant-pm3-opt.com
rm $NAME.cut
